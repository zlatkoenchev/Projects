...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/${CND_CONF}/${IMAGE_TYPE}/MRF89XA_PVboost.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
dist/${CND_CONF}/${IMAGE_TYPE}/MRF89XA_PVboost.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/MRF89XA_PVboost.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --rom=0-7FF --opt=+asm,+asmfile,-speed,+space,+debug,-local --addrqual=require --mode=pro -DDEBUG -P -N255 -I"../" -I"../../LIBC/MRF89_Drv" -I"../../LIBC/NVM" --warn=-3 -DXPRJ_Debug=$(CND_CONF)  --summary=default,+psect,-class,-mem,-hex,-file --fill=0@0x480:0x1FFF --codeoffset=0 --output=default,-inhx032 --runtime=default,-clear,-init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto -Q "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/MRF89XA_PVboost.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/MRF89XA_PVboost.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/MRF89XA_PVboost.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/MRF89XA_PVboost.X.${IMAGE_TYPE}.map  --double=24 --float=24 --rom=0-7FF --opt=+asm,+asmfile,-speed,+space,+debug,-local --addrqual=require --mode=pro -DDEBUG -P -N255 -I"../" -I"../../LIBC/MRF89_Drv" -I"../../LIBC/NVM" --warn=-3 -DXPRJ_Debug=$(CND_CONF)  --summary=default,+psect,-class,-mem,-hex,-file --fill=0@0x480:0x1FFF --codeoffset=0 --output=default,-inhx032 --runtime=default,-clear,-init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto -Q "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/MRF89XA_PVboost.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
